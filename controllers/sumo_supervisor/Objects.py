...
def height_lidar(car_model):
    ...
    elif car_model == 'CitroenCZeroSimple':
        translation = '0 0.13 0'
    elif car_model == 'ToyotaPriusSimple':
        translation = '0 0.18 0'
    elif car_model == 'LincolnMKZSimple':
        translation = '0 0.19 0'
    elif car_model == 'RangeRoverSportSVRSimple':
        translation = '0 0.18 0'
    elif car_model == 'TeslaModel3Simple':
        translation = '0 0.13 0'
    else:
        translation = '0 0.17 0'
...
def add_lidar(car_model):
    translation = height_lidar(car_model)
    lidar = f'  sensorsSlotTop [\n' \
            '    VelodyneHDL-64E {\n' \
            f'      translation {translation}\n' \
            f'      name "Velo"\n' \
            f'      enablePhysics FALSE\n' \
            '    }\n' \
            '  ]\n'
    return lidar
