...
%% Data paths
HOME = getenv('HOME');
dpath = HOME+"/webots_code/data/chicago/MAT/";
opath = HOME+"/webots_code/data/chicago/OSM/";
rpath = HOME+"/webots_code/data/chicago/Rays/";
save_dir = HOME+"/webots_code/data/chicago/labels/";
...
use_site = 1;
use_site = use_site + 1;
lat_sites = [[38.89328 38.89380 38.89393];[41.80978 41.80987 41.81047]];
lon_sites = [[-77.07611 -77.07590 -77.07644];[-87.97546 -87.97608 -87.97550]];
