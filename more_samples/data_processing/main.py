...
lpath = os.path.join(HOME,'webots_code','data','more_samples','lidar_samples')
gpath = os.path.join(HOME,'webots_code','data','more_samples','samples')
tpath = os.path.join(HOME,'webots_code','data','more_samples','tracking')
opath = os.path.join(HOME,'webots_code','data','more_samples','OSM')
matpath = os.path.join(HOME,'webots_code','data','more_samples','MAT')
gspath = os.path.join(HOME,'webots_code','data','more_samples','gps.pkl')
