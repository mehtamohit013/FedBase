...
dpath = f'{HOME}/webots_code/data/more_samples/samples'
lpath = f'{HOME}/webots_code/data/more_samples/lidar_samples'
tpath = f'{HOME}/webots_code/data/more_samples/tracking'
