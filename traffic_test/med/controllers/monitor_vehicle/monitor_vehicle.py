...
dpath = f'{HOME}/webots_code/data/traffic_test/med/samples'
lpath = f'{HOME}/webots_code/data/traffic_test/med/lidar_samples'
...
tpath = f'{HOME}/webots_code/data/traffic_test/med/tracking'
