...
dpath = f'{HOME}/webots_code/data/RAM/samples'
lpath = f'{HOME}/webots_code/data/RAM/lidar_samples'
...
gps_sample = pd.DataFrame(columns=['Time','Name','Model','GPS','Speed','Lidar'])
